...
INSTALL_BASE_DIR = r"D:\Tools\.PyTools\PyDatabaseBackup"

# 可执行文件名
EXE_NAME = "DatabaseBackup-Windows.exe"

# 快捷方式名称（不含 .lnk 后缀）
SHORTCUT_NAME = "DatabaseBackup-Windows"

# 快捷方式描述
SHORTCUT_DESCRIPTION = "数据库备份工具"
# =================================================
