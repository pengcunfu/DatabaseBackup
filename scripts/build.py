...
# 输出文件配置
OUTPUT_FILENAME = "DatabaseBackup-Windows.exe"  # 输出可执行文件名
...
DEPENDENCY_FOLDERS = ["resources"]      # 需要复制的文件夹列表（已移除qml文件夹）
DEPENDENCY_FILES = ["db_config.json", "config.yaml"]   # 需要复制的文件列表
# ==================================================
